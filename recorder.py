...
image_icon=PhotoImage(file="recording-icon-png-2.jpg")
root.iconphoto(False, image_icon)


photo=PhotoImage(file="recording-icon-png-2.jpg")
myimage=Label(image=photo, background="#4a4a4a")
myimage.pack(padx=5, pady=20)
...
record=Button(root, font="arial 20", text="Record", bg="#111111", fg="white", border=0, command=Record).pack(pady=10)
root.mainloop()
